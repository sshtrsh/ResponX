...
export const appConstants = {
  MAX_IMAGES: REPORT_CONSTANTS.MAX_IMAGES,
  MAX_DESCRIPTION_LENGTH: REPORT_CONSTANTS.DESCRIPTION_MAX_LENGTH,
  GPS_ACCURACY_DEFAULT: LOCATION_CONSTANTS.NORMAL_GPS_ACCURACY_METERS,
  GPS_ACCURACY_SOS: LOCATION_CONSTANTS.SOS_GPS_ACCURACY_METERS,
  MAX_BARANGAY_DISTANCE_KM: LOCATION_CONSTANTS.MAX_BARANGAY_DISTANCE_KM,
  API_TIMEOUT_MS: NETWORK_CONSTANTS.REQUEST_TIMEOUT_MS,
  AUTO_SAVE_DEBOUNCE_MS: REPORT_CONSTANTS.AUTO_SAVE_DEBOUNCE_MS,
  MIN_PASSWORD_LENGTH: AUTH_CONSTANTS.PASSWORD_MIN_LENGTH,
};
